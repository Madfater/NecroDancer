...
function Hit(damage, dir, playerDamage)
	if (chargingDir == DIR_NONE) then
        ...
        Self.overrideHitSound = "armadilloShielded"
        Self.health = tonumber(Self.health) + damage
    end
end
